    ...
    <div css={{
        ...
        <header>
            <ul css={{
                ...
                {props.activeWaypoints.indexOf('hero') < 0 && <NavLink styles={{ fontWeight: 600, letterSpacing: rhythm(1 / 4) }} to="top">
                    <span css={{ display: `inline`, fontWeight: 'bold', fontSize: rhythm(3 / 4), textTransform: 'none' }}>TRVPxHILL</span>
                </NavLink>}
            </ul>
